...
export default function Projects() {
  ...
  return (
    <section id="proyectos" className="py-14 md:py-20 bg-gray-50">
      <div className="container mx-auto px-4 md:px-6 max-w-7xl">
        <div className="text-center max-w-3xl mx-auto mb-10 md:mb-14">
          <span className="text-[var(--color-primary)] font-semibold tracking-wider uppercase text-xs mb-2 block">
            Nuestros Trabajos
          </span>
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-serif font-bold text-[var(--color-accent)] mb-4">
        ...
        {!loading && projects.length > 0 && (
          <div className="text-center mt-12">
            <Link
              to="/proyectos"
              className="inline-flex items-center gap-2 px-8 py-3.5 bg-[var(--color-primary)] text-white rounded-full font-medium shadow-md hover:shadow-lg hover:bg-opacity-90 transform hover:-translate-y-0.5 transition-all duration-300"
            >
