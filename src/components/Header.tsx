...
export default function Header() {
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-[var(--color-secondary)] shadow-md py-3' : 'bg-[var(--color-secondary)]/90 backdrop-blur-sm py-5'
        }`}
    >
      <div className="container mx-auto px-4 md:px-6 flex justify-between items-center max-w-7xl">
        <Link to="/" className="flex items-center gap-2" onClick={() => handleNavClick('/#inicio')}>
          <img src="/logo.png" alt="InnovaMob Logo" className="h-12 w-auto object-contain" />
        </Link>
